...
export default function ClippedDrawer() {
  ...
  return (
    ...
    <TextField label="Text Field 1" variant="outlined"  size='small'/>
            </Box>
            <Box>
            <Typography variant="h5" component="div" sx={{ fontSize: '1.5rem' }}>
        Student Name
    </Typography>
    <TextField label="Text Field 2" variant="outlined" size='small' />
            </Box>
            <Box>
            <Typography variant="h5" component="div" sx={{ fontSize: '1.5rem' }}>
        Issued Date
    </Typography>
    <TextField label="Text Field 3" variant="outlined" size='small'/>
            </Box>
